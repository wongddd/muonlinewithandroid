...
#define HARMONYJEWELOPTION_DATA_FILE std::string("Data\\Local\\JewelOfHarmonyOption.bmd").c_str()
#define NOTSMELTING_DATA_FILE std::string("Data\\Local\\JewelOfHarmonySmelt.bmd").c_str()
#else
#define HARMONYJEWELOPTION_DATA_FILE std::string("Data\\Local\\"+g_strSelectedML+"\\JewelOfHarmonyOption.bmd").c_str()
#define NOTSMELTING_DATA_FILE std::string("Data\\Local\\"+g_strSelectedML+"\\JewelOfHarmonySmelt.bmd").c_str()
