...
#define	QM_QUESTWORDS_FILE			std::string("Data\\Local\\QuestWords.bmd").c_str()
#else
#define	QM_QUESTWORDS_FILE			std::string("Data\\Local\\"+g_strSelectedML+"\\QuestWords.bmd").c_str()
...
{
	int i;
	LPPMSG_NPC_QUESTEXP_INFO pRequestRewardPacket = (LPPMSG_NPC_QUESTEXP_INFO)pbyRequestRewardPacket;
	...
	LPNPC_QUESTEXP_REQUEST_INFO pRequestPacket = (LPNPC_QUESTEXP_REQUEST_INFO)(pbyRequestRewardPacket + sizeof(PMSG_NPC_QUESTEXP_INFO));
