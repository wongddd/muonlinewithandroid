...
public:
	...
	{	//. strAlpha3Code: Official Alpha-3 Code
		if(0 == strAlpha3Code.compare("USA") || 0 == strAlpha3Code.compare("CAN"))
			return 130;
		if(0 == strAlpha3Code.compare("JPN"))
			return 450;
		if(0 == strAlpha3Code.compare("TPE"))
			return 471;
		if(0 == strAlpha3Code.compare("PHI"))
			return 480;
		if(0 == strAlpha3Code.compare("CHN"))
			return 690;
		if(0 == strAlpha3Code.compare("BRA"))
			return 789;
		if(0 == strAlpha3Code.compare("KOR"))
			return 880;
		if(0 == strAlpha3Code.compare("THA"))
			return 885;
		if(0 == strAlpha3Code.compare("VIE"))
			return 893;
		if(0 == strAlpha3Code.compare("FRN"))
			return 995;
...
protected:
	bool CheckLoadDisposition(int key, DWORD dwLoadDisposition)
	{
		...
		if( ((dwLoadDisposition & LD_USA_CANADA_TEXTS) == LD_USA_CANADA_TEXTS) && (KeyCode.GetCountryCode() == GetNumCountryCode("USA") || KeyCode.GetCountryCode() == GetNumCountryCode("CAN")) )
			return true;
		if( ((dwLoadDisposition & LD_JAPAN_A_TEXTS) == LD_JAPAN_A_TEXTS) && (KeyCode.GetCountryCode() == GetNumCountryCode("JPN")) )
			return true;
		if( ((dwLoadDisposition & LD_TAIWAN_TEXTS) == LD_TAIWAN_TEXTS) && (KeyCode.GetCountryCode() == GetNumCountryCode("TPE")) )
			return true;
		if( ((dwLoadDisposition & LD_PHILIPPINES_TEXTS) == LD_PHILIPPINES_TEXTS) && (KeyCode.GetCountryCode() == GetNumCountryCode("PHI")) )
			return true;
		if( ((dwLoadDisposition & LD_CHINA_A_TEXTS) == LD_CHINA_A_TEXTS) && (KeyCode.GetCountryCode() == GetNumCountryCode("CHN")) )
			return true;
		if( ((dwLoadDisposition & LD_BRAZIL_A_TEXTS) == LD_BRAZIL_A_TEXTS) && (KeyCode.GetCountryCode() == GetNumCountryCode("BRA")) )
			return true;
		if( ((dwLoadDisposition & LD_SOUTH_KOREA_TEXTS) == LD_SOUTH_KOREA_TEXTS) && (KeyCode.GetCountryCode() == GetNumCountryCode("KOR")) )
			return true;
		if( ((dwLoadDisposition & LD_THAILAND_TEXTS) == LD_THAILAND_TEXTS) && (KeyCode.GetCountryCode() == GetNumCountryCode("THA")) )
			return true;
		if( ((dwLoadDisposition & LD_VIETNAM_TEXTS) == LD_VIETNAM_TEXTS) && (KeyCode.GetCountryCode() == GetNumCountryCode("VIE")) )
			return true;
		if( ((dwLoadDisposition & LD_FOREIGN_TEXTS) == LD_FOREIGN_TEXTS) && (KeyCode.GetCountryCode() == GetNumCountryCode("FRN")) )
			return true;
		return false;
	}
};
