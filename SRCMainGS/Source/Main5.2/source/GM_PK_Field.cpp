...
bool CGM_PK_Field::RenderObjectVisual(OBJECT* o, BMD* b)
{
	...
	case 0:
	{
		...
		if (fLumi >= nRanTemp && fLumi <= nRanTemp + nRanGap)
		{
			...
			for (int i = 0; i < 20; ++i)
			{
				CreateParticleSync(BITMAP_WATERFALL_2, o->Position, o->Angle, Light, 6, o->Scale, o);
			}
		}
	}
	return true;
	case 1:
	{
		...
		{
			Vector(1.0f, 1.0f, 1.0f, Light);
			CreateParticleSync(BITMAP_SMOKE, o->Position, o->Angle, Light, 60, o->Scale, o);
		}
	}
	return true;
	case 2:
	...
	case 3:
	{
		...
		if (rand() % 4 == 0)
		{
			...
			CreateParticleSync(BITMAP_CLOUD, o->Position, o->Angle, Light, 11, o->Scale, o);
		}
	}
	return true;
	case 4:
	{
		...
		if (rand() % 3 == 0)
		{
			...
			CreateParticleSync(BITMAP_SPARK, o->Position, vAngle, Light, 9, o->Scale);
		}
	}
	return true;
	case 5:
	{
		...
		if (rand() % 3 == 0)
		{
			...
			CreateParticleSync(BITMAP_SMOKE, o->Position, o->Angle, o->Light, 21, o->Scale);
		}
	}
	return true;
	case 6:
...
bool CGM_PK_Field::RenderObjectMesh(OBJECT* o, BMD* b, bool ExtraMon)
{
	...
	else if (o->Type == 67)
	{
		...
		if (o->AnimationFrame >= 35.0f && o->AnimationFrame < 50.0f)
			CreateParticleSync(BITMAP_SMOKE, Pos, o->Angle, Light, 63, o->Scale * 1.5f);
	...
	else if (o->Type == 68)
	{
		...
		if (o->AnimationFrame >= 7.0f && o->AnimationFrame < 13.0f)
			CreateParticleSync(BITMAP_SMOKE, Pos, o->Angle, Light, 18, o->Scale * 1.5f);
			...
			for (int i = 0; i < 3; ++i)
			{
				...
				if (o->Type == MODEL_MONSTER01 + 160)
				{
					for (int i = 0; i < 2; ++i)
					{
						...
						{
						case 0:
							CreateParticleSync(BITMAP_FIRE_HIK1, vPos, o->Angle, vLight, 0, fScale);
							break;
						case 1:
							CreateParticleSync(BITMAP_FIRE_CURSEDLICH, vPos, o->Angle, vLight, 4, fScale);
							break;
						case 2:
							CreateParticleSync(BITMAP_FIRE_HIK3, vPos, o->Angle, vLight, 0, fScale);
							break;
						}
					}
				}
				else		//o->Type == MODEL_MONSTER01+161
				{
					for (int i = 0; i < 2; ++i)
					{
						...
						{
						case 0:
							CreateParticleSync(BITMAP_FIRE_HIK1_MONO, vPos, o->Angle, o->Light, 0, fScale);
							break;
						case 1:
							CreateParticleSync(BITMAP_FIRE_HIK2_MONO, vPos, o->Angle, o->Light, 4, fScale);
							break;
						case 2:
							CreateParticleSync(BITMAP_FIRE_HIK3_MONO, vPos, o->Angle, o->Light, 0, fScale);
							break;
						}
					}
				}
...
bool CGM_PK_Field::RenderMonsterVisual(CHARACTER* c, OBJECT* o, BMD* b)
{
	...
	case MODEL_MONSTER01 + 159:
	{
		...
		if (rand() % 4 == 0)
		{
			...
			CreateParticleSync(BITMAP_SMOKE, Position, o->Angle, o->Light, 61);
		}
	}
	return true;
	case MODEL_MONSTER01 + 160:
	case MODEL_MONSTER01 + 161:
	{
		...
		if (o->CurrentAction != MONSTER01_DIE)
		{
			for (int i = 0; i < 4; ++i)
			{
				...
				b->TransformByObjectBone(vPos, o, iBones[i]);
				CreateParticleSync(BITMAP_SMOKE, vPos, o->Angle, vLight, 50, 1.0f);
				CreateParticleSync(BITMAP_SMOKELINE1 + rand() % 3, vPos, o->Angle, vLight, 0, 0.01f);
			}
			...
			if (o->CurrentAction == MONSTER01_ATTACK1)
			{
				...
				CreateParticleSync(BITMAP_LIGHT + 2, vPos, o->Angle, vLight, 7, 0.5f);
				...
				CreateParticleSync(BITMAP_SPARK + 1, vPos, o->Angle, vLight, 29, 1.0f);
			}
		}
	...
	case MODEL_MONSTER01 + 163:
	{
		...
		if (o->CurrentAction == MONSTER01_WALK)
		{
			if (o->AnimationFrame >= 2.0f && o->AnimationFrame <= 2.4f)
			{
				...
				CreateEffectSync(iModel, vRelative, o->Angle, vLight, 0, o, -1, 0, 0, 0, 1.3f);
				CreateParticleSync(BITMAP_SMOKE, vRelative, o->Angle, vLight, 62, 1.0f);
			}
		...
		else if (o->CurrentAction == MONSTER01_ATTACK2)
		{
			if (o->AnimationFrame >= 6.0f && o->AnimationFrame <= 6.4f)
			{
				Vector(0.0f, 0.0f, 0.0f, vPos);
				b->TransformPosition(o->BoneTransform[42], vPos, vRelative, true);
				CreateEffectSync(iModel, vRelative, o->Angle, vLight, 0, o, -1, 0, 0, 0, 1.6f);
				CreateParticleSync(BITMAP_SMOKE, vRelative, o->Angle, vLight, 62, 4.0f);
			}
		}
